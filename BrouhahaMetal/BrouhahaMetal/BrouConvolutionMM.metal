 ...
 */
kernel void brouConvertInput2Matrix(device half *input   [[buffer(0)]],
    ...
    for (int y = 0; y < kernelHeight; ++y) {
        for (int x = 0; x < kernelWidth; ++x) {
            int k = 0;
            for (; k < limit; k += 4) {
                inputV0 = getHalf4FromInput(input, inputHeight, inputWidth, inputChannelX4, inputY0+y, inputX0+x, k);
                inputV1 = getHalf4FromInput(input, inputHeight, inputWidth, inputChannelX4, inputY1+y, inputX1+x, k);
                inputV2 = getHalf4FromInput(input, inputHeight, inputWidth, inputChannelX4, inputY2+y, inputX2+x, k);
                inputV3 = getHalf4FromInput(input, inputHeight, inputWidth, inputChannelX4, inputY3+y, inputX3+x, k);
