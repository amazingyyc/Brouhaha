...
@interface ArtTransformViewController () {
    BrouConvertFromuchar2floatLayer *rgbConvert1;
    
    BrouConvolutionLayer_float *conv1;
    BrouBatchNormalizationLayer_float *batchNorm1;
    BrouReLuLayer_float *relu1;
    
    BrouConvolutionMMLayer_float *conv2;
    BrouBatchNormalizationLayer_float *batchNorm2;
    BrouReLuLayer_float *relu2;
    
    BrouConvolutionMMLayer_float *conv3;
    BrouBatchNormalizationLayer_float *batchNorm3;
    BrouReLuLayer_float *relu3;
    
    BrouResidualLayer_float *res1;
    BrouResidualLayer_float *res2;
    BrouResidualLayer_float *res3;
    BrouResidualLayer_float *res4;
    BrouResidualLayer_float *res5;
    
    BrouTransposedConvolutionMMLayer_float *transposeConv1;
    
    BrouBatchNormalizationLayer_float *batchNorm4;
    BrouReLuLayer_float *relu4;
    
    BrouTransposedConvolutionMMLayer_float *transposeConv2;
    
    BrouBatchNormalizationLayer_float *batchNorm5;
    BrouReLuLayer_float *relu5;
    
    BrouConvolutionLayer_float *conv4;
    
    BrouBatchNormalizationLayer_float *batchNorm6;
    
    BrouTanHLayer_float *tanh1;
    BrouLinearLayer_float *linear1;
    
    BrouConvertFromfloat2ucharLayer *rgbConvert2;
...
- (void)viewDidLoad {
    ...
    NSString *imagePath  = [mainBundle pathForResource:@"zgr" ofType:@"jpg"];
...
- (void)initArtTransfrom {
    ...
    rgbConvert1 = [[BrouConvertFromuchar2floatLayer alloc] initWithDevice:device library:library dimensionType:Dimension3D];
    
    conv1  = [[BrouConvolutionLayer_float alloc] initWithDevice:device
                                                        library:library
    ...
    batchNorm1 = [[BrouBatchNormalizationLayer_float alloc] initWithDevice:device
                                                                   library:library
                                                                   epsilon:epsilon
    ...
    relu1 = [[BrouReLuLayer_float alloc] initWithDevice:device library:library dimensionType:Dimension3D];
    
    conv2 = [[BrouConvolutionMMLayer_float alloc] initWithDevice:device
                                                       library:library
    ...
    batchNorm2 = [[BrouBatchNormalizationLayer_float alloc] initWithDevice:device
                                                                   library:library
                                                                   epsilon:epsilon
    ...
    relu2 = [[BrouReLuLayer_float alloc] initWithDevice:device library:library dimensionType:Dimension3D];
    
    conv3 = [[BrouConvolutionMMLayer_float alloc] initWithDevice:device
                                                       library:library
    ...
    batchNorm3 = [[BrouBatchNormalizationLayer_float alloc] initWithDevice:device
                                                                   library:library
                                                                   epsilon:epsilon
    ...
    relu3 = [[BrouReLuLayer_float alloc] initWithDevice:device library:library dimensionType:Dimension3D];
    
    res1 = [[BrouResidualLayer_float alloc] initWithDevice:device
                                                   library:library
    ...
    res2 = [[BrouResidualLayer_float alloc] initWithDevice:device
                                                   library:library
    ...
    res3 = [[BrouResidualLayer_float alloc] initWithDevice:device
                                                   library:library
    ...
    res4 = [[BrouResidualLayer_float alloc] initWithDevice:device
                                                   library:library
    ...
    res5 = [[BrouResidualLayer_float alloc] initWithDevice:device
                                                   library:library
    ...
    transposeConv1 = [[BrouTransposedConvolutionMMLayer_float alloc] initWithDevice:device
                                                                          library:library
    ...
    batchNorm4 = [[BrouBatchNormalizationLayer_float alloc] initWithDevice:device
                                                                   library:library
                                                                   epsilon:epsilon
    ...
    relu4 = [[BrouReLuLayer_float alloc] initWithDevice:device library:library dimensionType:Dimension3D];
    
    transposeConv2 = [[BrouTransposedConvolutionMMLayer_float alloc] initWithDevice:device
                                                                          library:library
    ...
    batchNorm5 = [[BrouBatchNormalizationLayer_float alloc] initWithDevice:device
                                                                   library:library
                                                                   epsilon:epsilon
    ...
    relu5 = [[BrouReLuLayer_float alloc] initWithDevice:device library:library dimensionType:Dimension3D];
    
    conv4 = [[BrouConvolutionLayer_float alloc] initWithDevice:device
                                                       library:library
    ...
    batchNorm6 = [[BrouBatchNormalizationLayer_float alloc] initWithDevice:device
                                                                   library:library
                                                                   epsilon:epsilon
    ...
    linear1 = [[BrouLinearLayer_float alloc] initWithDevice:device library:library a:150 b:255.0 / 2.0 dimensionType:Dimension3D];
    
    rgbConvert2 = [[BrouConvertFromfloat2ucharLayer alloc] initWithDevice:device library:library dimensionType:Dimension3D];
