...
@interface BrouTanHLayer() {
    ...
    /**
     * store the shepe of input/output
     */
    id<MTLBuffer> _shape;
...
- (instancetype)initWithDevice:(id<MTLDevice>)device
                       library:(id<MTLLibrary>)lirary
                        height:(int)height
                         width:(int)width
                       channel:(int)channel {
    self = [super initWithLabel:@"BrouTanHLayer"];
