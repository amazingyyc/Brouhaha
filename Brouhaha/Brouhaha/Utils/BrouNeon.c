 ...
 */
void brouMatrixTranspose4X4Neon_uint16_t(uint16_t *src, size_t srcRowBytes, uint16_t *dst, size_t dstRowBytes) {
...
void brouMatrixTranspose4X4Neon_half(uint16_t *src, size_t srcRowBytes, uint16_t *dst, size_t dstRowBytes) {
    brouMatrixTranspose4X4Neon_uint16_t(src, srcRowBytes, dst, dstRowBytes);
}

/**
 * traspose 4X4 float matrix use neon
 */
void brouMatrixTranspose4X4Neon_float(float *src, size_t srcRowBytes, float *dst, size_t dstRowBytes) {
#if defined(__aarch64__)
    __asm__ __volatile__ (
 ...
 */
void brouMatrixTranspose4X4Neon_double(double *src, size_t srcRowBytes, double *dst, size_t dstRowBytes) {
#if defined(__aarch64__)
    __asm__ __volatile__ (
